      ...
      <div className="w-full">
                ...
                <DialogDescription>
                  <div className="flex justify-between mx-2">
                    <div className="text-xs text-black">
                      <div className="mb-2">
                        <p>Kurir</p>
                        <p className="font-bold">{props.courier?.courier_code} {props.courier?.courier_service_name}</p>
                      </div>
                      ...
                      <div className="mb-2">
                        ...
                        <p className="font-bold">{props.courier?.tracking_id}</p>
                      </div>
                  ...
                  <div className="text-xs text-black my-3">
                    <p>Status: <span className="font-bold">{props.invoice?.status}</span></p>
        ...
        <div className="pb-3">
          <div className="flex">
            ...
            <p>{props.courier?.courier_code} {props.courier?.courier_service_name}</p>
          </div>
