...
import { BsCash, BsInfoCircle, BsReceipt } from "react-icons/bs";
import WithdrawDialog from "./components/withdrawDialog";

export function DashboardPage() {
    return (
        <div className=" w-full flex flex-col gap-4 p-4 bg-white rounded">
            <h1 className="text-2xl font-bold">Credit Dashboard</h1>

            {/* box 1 */}
            <div className="flex gap-4 rounded shadow-md border overflow-hidden">
