...
const RejectDialog: FC<{ dataWithdraw: IDataWithdraw; }> = ({ dataWithdraw }) => {
    ...
    const handleReject = async () => {
        ...
        await Axios({
            method: 'patch',
            url: `http://localhost:3000/withdraw/reject/r/${dataWithdraw.id}`,
            params: {
                userId: userId
            },
            headers: {
                    ...
                    <DialogDescription>
                        <div className="mt-4 text-black">
                            ...
                            <div className="flex flex-col gap-2 mt-4 p-2 border rounded shadow-lg">
                                ...
                                <div>
                                    {dataWithdraw.bank} - {dataWithdraw.rekening} - {dataWithdraw.name}
                                </div>

                                <Label>Nominal</Label>
                                <div>
                                    Rp{dataWithdraw.nominal}
                                </div>
                            </div>
                        </div>
                    </DialogDescription>
