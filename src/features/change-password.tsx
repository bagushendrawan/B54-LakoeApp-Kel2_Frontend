...
export function ChangePassword() {
  ...
  return (
    <div className="w-8/12 h-10/12 rounded-sm mt-32 m-auto flex">
      ...
      <h1 className="font-bold text-2xl text-red-600 mt-2 mb-4">Change Your Password</h1>
      <Form {...form}>
        <form
        ...
        >
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="mt-4">
                ...
                <FormControl>
                  <Input type="password" placeholder="Masukan email" {...field} required {...form.register("password")}/>
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="mt-4">
                ...
                <FormControl>
                  <Input type="password" placeholder="Masukan password" {...field} required {...form.register("c_password", {required: true, validate: (value) => value === watchFields.password || 'Password does not match' })}/>
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <div className="flex gap-4 items-center text-sm">
            {!form.formState.isSubmitting ? <Button type="submit" className="bg-red-600">Change</Button> : <Button type="submit" disabled className="bg-red-600">Change <LoadingSpinner></LoadingSpinner></Button>}
